    ...
    static function isNewLayout()
    {
        ...
        if ($new_layout == 'modern') {
            ...
            if (is_page() and is_page_template('template-checkout.php')) {
                $booking_id = STCart::get_booking_id();
                $post_type = get_post_type($booking_id);
                if (in_array($post_type, array('hotel_room', 'st_tours', 'st_activity'))) {
                    $check = true;
                }
            }
            ...
            if (is_page() and is_page_template('template-payment-success.php')) {
                ...
                if (in_array($post_type, array('st_hotel', 'hotel_room', 'st_tours', 'st_activity'))) {
                    $check = true;
                }
            }
